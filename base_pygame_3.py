...
based on: http://www.roguebasin.com/index.php?title=Complete_Roguelike_Tutorial,_using_python%2Blibtcod,_part_3

adding rooms and tunnels
"""
import pygame
import random
#import inspect
...
class Game():
    ...
    def __init__(self, tiles_x=80, tiles_y=40, start_x=25, start_y=23):
        ...
        # carve out 2 rooms
        self.create_room(Rect(20, 15, 10, 15),z=0)
        self.create_room(Rect(50, 15, 10, 15),z=0)
        # carve out connection tunnel
    ...
    def create_room(self, rect, z=0):
        """needs a rect object and carves a room out of this (z) dungeon level"""
